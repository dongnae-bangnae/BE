...
public enum SuccessStatus implements BaseCode {
    ...
    MEMBER_ONBOARDING_SUCCESS(HttpStatus.CREATED, "MEMBER2003", "온보딩을 성공적으로 완료했습니다."),
    MEMBER_ALREADY_ONBOARDING_COMPLETED(HttpStatus.CREATED, "MEMBER2004", "이미 온보딩이 완료된 유저입니다."),
    MEMBER_INFO_RETRIEVED(HttpStatus.OK, "MEMBER2005", "유저 정보를 성공적으로 조회했습니다."),
    MEMBER_LOGOUT_SUCCESS(HttpStatus.OK, "MEMBER2006", "로그아웃이 성공적으로 완료되었습니다."),
    MEMBER_DELETE_SUCCESS(HttpStatus.NO_CONTENT, "MEMBER2007", "회원 탈퇴가 성공적으로 완료되었습니다."),
    MEMBER_PROFILE_IMAGE_UPDATED(HttpStatus.OK, "MEMBER2008", "프로필 이미지가 성공적으로 변경되었습니다."),
