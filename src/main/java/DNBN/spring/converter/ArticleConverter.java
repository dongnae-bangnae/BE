...
public class ArticleConverter {
    public static ArticleResponseDTO toArticleResponseDTO(Article article, List<ArticlePhoto> photos) {
        return ArticleResponseDTO.builder()
                ...
                .placeId(article.getPlace() != null ? article.getPlace().getPlaceId() : null)
                .regionId(article.getRegion().getId())
                .placeName(article.getPlace() != null ? article.getPlace().getTitle() : null)
                .pinCategory(article.getPlace() != null && article.getPlace().getPinCategory() != null ? article.getPlace().getPinCategory().name() : null)
                .detailAddress(article.getPlace() != null ? article.getPlace().getAddress() : null)
